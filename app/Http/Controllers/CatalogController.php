...
class CatalogController extends Controller
{
  ...
  //$pelicula1 = array("Lo que el viento se llevo", "La historia de Ale el Gay", "Chuky", "Anaconda");
  ...
  /*  $arrayPeliculas =array(
     array(
       "title"   =>   "Anaconda",
       "poster"   =>   "/img/Anaconda-1.jpg"
     ),
     array(
       "title"   =>   "Anaconda2",
       "poster"   =>   "/img/Anaconda-2.jpg"
     ),
   );*/
      return view('catalog.show', array('id'=>$id,'arrayPeliculas'=>$this->arrayPeliculas));
  }
  ...
  {
    /*En esta seccion agrego el array para crear el form dinamico*/
    $arrayForm = array(
       array(
         'name' => 'title',
         'id' => 'idTitulo',
      ...
      return view('catalog.create',array('arrayForm'=>$arrayForm));
  }
  public function getEdit($id)
  {
    ...
    $arrayForm = array(
      ...
      return view('catalog.edit', array('id'=>$id,'arrayForm'=>$arrayForm));
  }
}
